...
{{--                @if(isset($batchId))--}}
{{--                    <li>--}}
{{--                        <a href="{{ route('portal.upload', ['batch_id'=>$batchId]) }}" title="Upload Files" class="hover:text-blue-400">--}}
{{--                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">--}}
...
{{--                    </li>--}}
{{--                    <li>--}}
{{--                        <a href="{{ route('portal.files', ['batch_id'=>$batchId]) }}" title="My Files" class="hover:text-blue-400">--}}
{{--                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">--}}
